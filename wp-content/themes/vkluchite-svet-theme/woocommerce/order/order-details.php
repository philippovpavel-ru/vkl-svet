...
<?php if (is_checkout()) : ?>
	...
	<?php
	if ($show_downloads) {
		echo '<div class="sd-vacantions__card">';
		wc_get_template(
	...
	?>
	<section class="sd-vacantions__card woocommerce-order-details">
		...
		<?php if ($order->get_customer_note()) : ?>
			<div>
				<p>
					...
					<span><?php echo wp_kses(nl2br(wptexturize($order->get_customer_note())), array()); ?><span>
				</p>
			</div>
		<?php endif; ?>
